...
if("TRUE" STREQUAL "TRUE")
  set(low_level_control_SOURCE_PREFIX /home/ebrahim/medical_robot/src/low_level_control)
  set(low_level_control_DEVEL_PREFIX /home/ebrahim/medical_robot/devel)
  ...
  set(low_level_control_INSTALL_PREFIX /home/ebrahim/medical_robot/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'low_level_control' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'low_level_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ebrahim/medical_robot/src/low_level_control/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT low_level_control_NUM_DUMMY_TARGETS)
      set(low_level_control_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::low_level_control::wrapped-linker-option${low_level_control_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR low_level_control_NUM_DUMMY_TARGETS "${low_level_control_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::low_level_control::wrapped-linker-option${low_level_control_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND low_level_control_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(low_level_control_EXPORTED_TARGETS ${${low_level_control_dep}_EXPORTED_TARGETS})
endforeach()
